	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>
					<i class="icon-edit"></i> <fmt:message key="system.config.define"/>
				</h2>
				<div class="box-icon">
					<a href="${ctx}/web/systemconfig" class="btn btn-round"><i
						class="icon-list"></i></a>
				</div>
			</div>
			<div class="box-content">
				<form:form class="form-horizontal form-valid" id="inputForm"
					modelAttribute="model" action="${ctx}/web/sc/save" 
					method="post" >
					...
					<fieldset class="prepend-top">
						...
						<div class="control-group">
							<label for="password" class="control-label"><fmt:message key="system.config.ismonitor"/></label>
							<div class="controls">
						...
						<div class="control-group">
							<label class="control-label" for="loginName"><fmt:message key="system.config.day"/></label>
							<div class="controls">
								<form:input path="userday" datatype="*" size="50" nullmsg="请填写信息"
									 class="input_text"/>
							</div>
						</div>
						<div class="control-group">
